...
import { ManageSubscriptionDto } from "../ManageSubscriptionDto";
...
export class SubscriptionServiceBase {
  ...
  async HandleSubscription(args: ManageSubscriptionDto): Promise<string> {
    throw new Error("Not implemented");
  }
  async ManageSubscription(args: string): Promise<string> {
    throw new Error("Not implemented");
  }
}
